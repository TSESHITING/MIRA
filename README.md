...
[![API](https://img.shields.io/badge/API-Google%20Gemini-orange.svg)](https://ai.google.dev/)

Developed as the final project for the **Intelligent Human-Computer Interaction** course at university. `MIRA` is an innovative Unity 2D game that gamifies traditional Chinese idiom learning by combining it with psychological fortune-telling and modern Generative AI (**Google Gemini API**).
...
*   **The Dominant CEO (霸道總裁)**
*   **The Rich Young Lady (大小姐)**
*   **The Innocent Younger Boy / "Puppy" (小奶狗)**
*   **The Wise Sage (智者)**
...
API implementation inspired and referenced from Gemini_Chat_Avatar.
---
